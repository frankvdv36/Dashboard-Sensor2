...
# Links boven
    ...
    def draw1(self, percent): 
        ...
        self.screen.blit(self.Font.render(time.strftime("%H:%M | %d-%m"), True, txt), (x1,y1))                          # Txt midden in beeld Local time Date
...
# Rechts onder
    ...
    def draw4(self, percent):
        ...
        fill_angle = int((co2-500)*270/1000)       # hoek per 50%  vb (270* 1000/500)
...
#-----------------------------------------------------------------------
    ...
    while True:
        ...
        try:
            ...
            print("Uitlezen I2C loopt mis")     # Indien iets fout loopt in het uitlezen wordt het programma niet gestopt
        time.sleep(5)
        #print (mylist)
